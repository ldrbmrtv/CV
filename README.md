...
-	Programming languages: Python, SQL, RDF, SPARQL, OWL, Datalog
-	Data libs: NumPy, pandas, BeautifulSoup, SQLAlchemy, NLTK, OpenCV
-	ML libs: SciPy, sklearn, mlxtend, statsmodels, Keras, transformers
-	Visualization: matplotlib, plotly, graphviz 
-	Semantic technologies: Protégé, owlready2
...
See [Google Scholar](https://scholar.google.se/citations?user=aG08GegAAAAJ)

## Lecturing
-	Non-classical logics (MA students)
-	Machine learning methods (MA students)
